...
QT_MOC_LITERAL(1, 12, 12), // "userApproved"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "User*"
QT_MOC_LITERAL(4, 32, 13) // "attempt_login"

    },
    "loginWindow\0userApproved\0\0User*\0"
    "attempt_login"
};
...
void loginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->attempt_login(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (loginWindow::*)(User * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&loginWindow::userApproved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void loginWindow::userApproved(User * _t1)
{
